...
const float PARCEL_WIDTH = 16.0f;  // Known width of the object (e.g., bus width in cm)
const float PARCEL_HEIGHT = 12.0f;  // Known height of the object (e.g., bus width in cm)
const float PARCEL_DIAMETER = 6.0f;
